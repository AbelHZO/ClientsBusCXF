...
/**
 * <p>Clase Java para loginUserSOAPResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="loginUserSOAPResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "loginUserSOAPResponse", propOrder = {
    "userRS"
})
public class LoginUserSOAPResponse {
