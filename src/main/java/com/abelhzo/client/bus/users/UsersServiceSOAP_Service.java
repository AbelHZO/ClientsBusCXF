 ...
 * 2017-05-03T19:15:27.206-05:00
 * Generated source version: 3.1.10
 * 
 */
@WebServiceClient(name = "UsersServiceSOAP", 
                  wsdlLocation = "http://localhost:8080/UsersManagementSOAP/UsersServiceSOAP?wsdl",
...
public class UsersServiceSOAP_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/UsersManagementSOAP/UsersServiceSOAP?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(UsersServiceSOAP_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/UsersManagementSOAP/UsersServiceSOAP?wsdl");
        }
        WSDL_LOCATION = url;
    }
