...
/**
 * <p>Clase Java para updateUserSOAPResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="updateUserSOAPResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "updateUserSOAPResponse", propOrder = {
    "userRS"
})
public class UpdateUserSOAPResponse {
