...
/**
 * <p>Clase Java para saveUserSOAPResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="saveUserSOAPResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "saveUserSOAPResponse", propOrder = {
    "userRS"
})
public class SaveUserSOAPResponse {
