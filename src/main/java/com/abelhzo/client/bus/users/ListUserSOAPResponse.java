...
/**
 * <p>Clase Java para listUserSOAPResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="listUserSOAPResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "listUserSOAPResponse", propOrder = {
    "userRS"
})
public class ListUserSOAPResponse {
