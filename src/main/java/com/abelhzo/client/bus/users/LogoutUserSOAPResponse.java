...
/**
 * <p>Clase Java para logoutUserSOAPResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="logoutUserSOAPResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "logoutUserSOAPResponse", propOrder = {
    "userRS"
})
public class LogoutUserSOAPResponse {
