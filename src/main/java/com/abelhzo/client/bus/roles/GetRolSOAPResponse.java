...
/**
 * <p>Clase Java para getRolSOAPResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="getRolSOAPResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "getRolSOAPResponse", propOrder = {
    "rolRS"
})
public class GetRolSOAPResponse {
