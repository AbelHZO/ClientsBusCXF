...
/**
 * <p>Clase Java para updateRolSOAPResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="updateRolSOAPResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "updateRolSOAPResponse", propOrder = {
    "rolRS"
})
public class UpdateRolSOAPResponse {
