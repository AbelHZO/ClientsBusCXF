...
/**
 * <p>Clase Java para listRolSOAPResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="listRolSOAPResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "listRolSOAPResponse", propOrder = {
    "rolRS"
})
public class ListRolSOAPResponse {
